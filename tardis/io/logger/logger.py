...
class TARDISLogger:
    ...
    def configure_logging(self, log_level, tardis_config, specific_log_level=None):
        ...
        specific_log_level = debug_config.get("specific_log_level", specific_log_level)
        logging_level = log_level or debug_config.get("log_level", self.config.DEFAULT_LEVEL)
